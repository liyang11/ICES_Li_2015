...
PARAMETER_SECTION
  ...
  init_bounded_dev_vector recruit_devs(fyear,lyear,-8.,8.,1)  //Annual recruitment deviations
...
REPORT_SECTION
  ...
  report<<N(lyear)<<endl;  //estimated total abundance in the last year of the assessment  
