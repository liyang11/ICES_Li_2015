...
DATA_SECTION
  ...
  init_vector wt_age(fage,lage)  //not being used, comment by liu
...
INITIALIZATION_SECTION
  ...
  log_qrc -14.0              //Recreational catchability
...
PARAMETER_SECTION
  ...
  init_bounded_number log_qrc(-16.,-10.,1)                 //Recreational catchability coefficient
  init_bounded_number log_rc_s_p1(-3.,3.,1)                //Recreational selectivity parameter 1
  init_bounded_number rc_s_p2(-3.,3.,1)                    //Recreational selectivity parameter 2
  init_bounded_number log_initial(8.,19.,1)                 //Numbers of age-2 and older fish in the first year
  init_bounded_dev_vector initial_devs(fage+1,lage,-10.,10.,1)
  init_bounded_number log_mean_recruit(8.0,19.,1)           //Average recruitment over the years - log scale
  init_bounded_dev_vector recruit_devs(fyear,lyear,-10.,10.,1)  //Annual recruitment deviations
  init_bounded_dev_vector log_effort_devs(fyear,lyear,-25.,25.,1)
  ...
  vector Total_ssb(fyear,lyear)                        //Predicted total abundance weight(~ssb)
...
FUNCTION get_TAC
   dvar_matrix abund(lyear,lyear+2,fage,lage); //only used for tac calculation
...
REPORT_SECTION
  ...
  report<<Total_ssb(lyear)<<endl;  //estimated total abundance in the last year of the assessment  __need to be changed later
  ...
  report << rc_s(1)<< endl;  //changed by liu
